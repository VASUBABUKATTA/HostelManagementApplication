...
//	}
	...
	public ResponseEntity<String> createHostlerFee(HostlerFeeDto hostlerFeeDto) {
	    ...
	    try {
	        ...
	        hostlerFeeDto.setHostlerMobile(existingHostler.getHostlerMobile());
	        hostlerFeeDto.setHostlerName(existingHostler.getHostlerName());
	        hostlerFeeDto.setHostlertEmail(existingHostler.getHostlerEmail());
	        hostlerFeeDto.setHostlerRoomNo(existingHostler.getHostlerRoomNo());
